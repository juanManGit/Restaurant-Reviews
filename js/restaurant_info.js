...
fillRestaurantHTML = (restaurant = self.restaurant) => {
  ...
  cuisine.setAttribute("aria-label","Restaurant cuisine type is" + restaurant.cuisine_type)
...
createReviewHTML = (review) => {
  ...
  name.setAttribute("tabindex", "0");
  name.setAttribute("aria-label", "Reviewer's username is " + review.name )
  ...
  rating.setAttribute("aria-label", `Reviewer's rating is ${review.rating} out of 5`);
